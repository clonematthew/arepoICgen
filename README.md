...
| turbSize | **128**, _integer_ | The size of the velocity grid (assumed equal length cubic), needed only for _turbFile_ | |
| rotation | **none**, rotation | Whether to add rotation to the cloud | beta, rotationRadius |
| extras | **none**, bossBodenheimer, densityGradient, bonnorEbert | What density perturbation to add to the cloud, either Boss Bodenheimer[^2], a linear density gradient[^3] or a Bonnor-Ebert[^4] density profile (note this setting automatically outputs density as mass) |
